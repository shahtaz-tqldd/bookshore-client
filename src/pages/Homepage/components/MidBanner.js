...
const MidBanner = () => {
    return (
        <div className="hero bg-secondary my-16 py-12">
            <div className="hero-content flex-col lg:flex-row-reverse justify-around">
                <div>
                    <h1 className="text-3xl font-bold mb-8">What You Can Do in Bookshore</h1>
                ...
                <div className="w-1/2">
                    <img src={bookreading} alt="a book" className='w-2/3' />
                </div>
            </div>
        </div>
    )
