...
const Advertisement = ({ adsItems }) => {
  ...
  return (
    <div className="my-40">
      <h1 className='lg:text-[80px] md:text-5xl text-3xl text-center font-bold mb-20 text-[#E96479] max-w-[800px] mx-auto'>grab<br /> <small><small>the best one now</small></small></h1>
