...
const SellerProducts = () => {
    ...
    const { data: products = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://bookshore-server-shahtaz-tqldd.vercel.app/my-products?email=${user?.email}`, {
                headers: {
    ...
    const handleRemoveProduct = (product) => {
        fetch(`https://bookshore-server-shahtaz-tqldd.vercel.app/products/remove/${product._id}`, {
            method: 'DELETE',
            headers: {
                authorization: `Bearer ${localStorage.getItem('accessToken')}`
            }
    ...
    const handleAdvertiseProduct = (productInfo) => {
        fetch('https://bookshore-server-shahtaz-tqldd.vercel.app/products/advertised', {
            method: 'POST',
            headers: {
    ...
    const advertiseStatusToDB = (id) => {
        fetch(`https://bookshore-server-shahtaz-tqldd.vercel.app/products/advertise/${id}`, {
            method: 'PUT',
            headers: {
                authorization: `Bearer ${localStorage.getItem('accessToken')}`
            }
